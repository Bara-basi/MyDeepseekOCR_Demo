    ...
    with gr.Blocks(title="🐳DeepSeek-OCR🐳", theme=gr.themes.Soft()) as demo:
        gr.Markdown(
            ...
            **💡 使用方法:**
            ...
            5. 感谢[https://modelscope.cn/studios/xmccln/DeepSeek-OCR-demo](https://modelscope.cn/studios/xmccln/DeepSeek-OCR-demo)的工具！
            """
        )
...
def main() -> None:
    ...
    # 创建并启动UI
    demo = create_ui()
    demo.queue(max_size=20).launch(share=False,server_port=7890)
